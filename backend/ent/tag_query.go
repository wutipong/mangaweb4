...
func (_q *TagQuery) QueryMeta() *MetaQuery {
...
func (_q *TagQuery) QueryFavoriteOfUser() *UserQuery {
...
func (_q *TagQuery) WithMeta(opts ...func(*MetaQuery)) *TagQuery {
	query := (&MetaClient{config: _q.config}).Query()
...
func (_q *TagQuery) WithFavoriteOfUser(opts ...func(*UserQuery)) *TagQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := _q.withMeta; query != nil {
		if err := _q.loadMeta(ctx, query, nodes,
...
func (_q *TagQuery) loadMeta(ctx context.Context, query *MetaQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Meta)) error {
...
func (_q *TagQuery) loadFavoriteOfUser(ctx context.Context, query *UserQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *User)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*Tag)
	nids := make(map[int]map[*Tag]struct{})
	for i, node := range nodes {
