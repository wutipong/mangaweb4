...
func (_q *HistoryQuery) QueryItem() *MetaQuery {
...
func (_q *HistoryQuery) WithItem(opts ...func(*MetaQuery)) *HistoryQuery {
	query := (&MetaClient{config: _q.config}).Query()
...
func (_q *HistoryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*History, error) {
	...
	if _q.withItem != nil || _q.withUser != nil {
		withFKs = true
	}
	if withFKs {
...
func (_q *HistoryQuery) loadItem(ctx context.Context, query *MetaQuery, nodes []*History, init func(*History), assign func(*History, *Meta)) error {
